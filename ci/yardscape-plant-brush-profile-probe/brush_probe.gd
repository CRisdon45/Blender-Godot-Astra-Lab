...
func validate_profile(profile:Dictionary,expected_groups:int,expected_cards:int,label:String)->String:
	...
	check(brush.stats.authored_atlas and brush.stats.atlas_id=="northstar-broad-mass-atlas/1",label+" uses the explicit broad-mass Northstar atlas")
